...
@section('title', 'Manage Lead Sources')
...
<div class="dashboard-main-body">
	...
	<div class="card border-0 mb-24">
		<div class="card-body p-24 d-flex justify-content-between align-items-center">
			...
			<a href="{{ route('admin.lead-sources.create') }}" class="btn btn-primary radius-12 d-inline-flex align-items-center gap-2">
							...
							<tr>
								...
								<td class="text-end">
									<div class="d-inline-flex gap-2">
										<a href="{{ route('admin.lead-sources.edit', $leadSource) }}" class="w-36-px h-36-px bg-primary-focus text-primary-main rounded-circle d-inline-flex align-items-center justify-content-center">
