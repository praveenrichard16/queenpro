...
<div class="dashboard-main-body">
	<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
		<h6 class="fw-semibold mb-0">Add Lead Source</h6>
		<ul class="d-flex align-items-center gap-2">
			...
			<li>-</li>
			<li class="fw-medium">
				<a href="{{ route('admin.lead-sources.index') }}" class="hover-text-primary">Lead Sources</a>
			</li>
			<li>-</li>
			...
			<form method="POST" action="{{ route('admin.lead-sources.store') }}" class="row g-4">
				...
				<div class="col-12">
					<div class="d-flex gap-2">
						...
						<a href="{{ route('admin.lead-sources.index') }}" class="btn btn-outline-secondary radius-12 h-56-px">Cancel</a>
					</div>
				</div>
			</form>
		</div>
