				...
				<div class="card-body p-24">
					<div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
						<div>
							...
							<code class="text-danger"><?php echo e(url('/api/v1')); ?></code>
						</div>
						<div class="d-flex gap-2">
							<button type="button" class="btn btn-outline-secondary radius-12" onclick="copyToClipboard('<?php echo e(url('/api/v1')); ?>')">
								<iconify-icon icon="solar:copy-outline" class="me-1"></iconify-icon>
								Copy
							</button>
							<a href="<?php echo e(route('admin.api.test-console')); ?>" class="btn btn-primary radius-12">
								<iconify-icon icon="solar:code-square-outline" class="me-1"></iconify-icon>
								Test API
							</a>
							<a href="<?php echo e(route('admin.api-tokens.index')); ?>" class="btn btn-outline-secondary radius-12">
			...
			<div id="getting-started" class="api-section">
				<div class="card border-0 mb-24">
					<div class="card-body p-24">
						...
						<ol class="mb-0">
							<li class="mb-2">Get your API token from the <a href="<?php echo e(route('admin.api-tokens.index')); ?>">Token Management</a> page</li>
							...
							<li class="mb-0">Test your integration using the <a href="<?php echo e(route('admin.api.test-console')); ?>">API Testing Interface</a></li>
						</ol>
						<div class="alert alert-info mt-16">
							<iconify-icon icon="solar:info-circle-bold"></iconify-icon>
							<strong>Base URL:</strong> All API requests should be made to <code><?php echo e(url('/api')); ?></code>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="authentication" class="api-section" style="display: none;">
				<div class="card border-0 mb-24">
					<div class="card-body p-24">
						...
						<pre class="bg-neutral-50 p-16 radius-12 mb-0"><code>curl -X GET "<?php echo e(url('/api/v1')); ?>/leads" \
			...
			<div id="token-management" class="api-section" style="display: none;">
				<div class="card border-0 mb-24">
					<div class="card-body p-24">
						...
						<p class="mb-16">
							API tokens are used to authenticate requests. You can create, manage, and revoke tokens from the <a href="<?php echo e(route('admin.api-tokens.index')); ?>">API Token Management</a> page.
						</p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ecom123\resources\views/admin/api/documentation.blade.php ENDPATH**/ ?>