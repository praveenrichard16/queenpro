<div class="tab-pane fade show active" id="user-pane-admins" role="tabpanel">
		...
		<div class="card-body p-24">
			<form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="row gy-3 gx-3 align-items-end">
				...
				<div class="col-xl-3 col-lg-4 d-flex gap-2">
					...
					<a href="<?php echo e(route('admin.users.index', ['tab' => 'admins'])); ?>" class="btn btn-outline-secondary h-56-px radius-12">
						<iconify-icon icon="mi:refresh"></iconify-icon>
					</a>
				</div>
				<div class="col-xl-3 col-lg-12 text-lg-end">
					<a href="<?php echo e(route('admin.users.create', ['role' => 'admin'])); ?>" class="btn btn-warning radius-12 text-white d-inline-flex align-items-center gap-2 h-56-px">
...
<?php endif; ?>
								...
								<td>
									<span class="px-20 py-6 rounded-pill fw-semibold text-sm <?php echo e($user->is_super_admin ? 'bg-danger-focus text-danger-main' : 'bg-primary-focus text-primary-main'); ?>">
										<?php echo e($user->is_super_admin ? 'Super Admin' : 'Administrator'); ?>
								...
								<td class="text-end">
									<div class="d-inline-flex gap-2">
										<a href="<?php echo e(route('admin.users.admin-activity', $user)); ?>" class="w-36-px h-36-px bg-info-focus text-info-main rounded-circle d-inline-flex align-items-center justify-content-center" title="View Activity">
										...
										<?php if(!$user->is_super_admin): ?>
											<form action="<?php echo e(route('admin.users.destroy', $user)); ?>" method="POST" onsubmit="return confirm('Delete this admin?')" class="d-inline">
												<?php echo csrf_field(); ?>
						...
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
							<tr>
								<td colspan="6" class="text-center py-80">
									<img src="<?php echo e(asset('wowdash/assets/images/notification/empty-message-icon1.png')); ?>" alt="No admins" class="mb-16" style="max-width:120px;">
									<h6 class="fw-semibold mb-8">No admins found</h6>
									<p class="text-secondary-light mb-0">Try adjusting your filters or add a new admin.</p>
								</td>
							</tr>
						<?php endif; ?>
					</tbody>
...
<?php /**PATH D:\xampp\htdocs\ecom123\resources\views/admin/users/partials/admins.blade.php ENDPATH**/ ?>