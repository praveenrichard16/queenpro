...
<?php $__env->startSection('title', 'API Usage Statistics'); ?>
				...
				<div class="card-body p-24">
					<div class="d-flex align-items-center justify-content-between">
						<div>
							...
							<h3 class="fw-semibold mb-0"><?php echo e($recentUsage); ?></h3>
				...
				<div class="card-body p-24">
					<div class="d-flex align-items-center justify-content-between">
						<div>
							...
							<h3 class="fw-semibold mb-0"><?php echo e($webhookSuccessRate); ?>%</h3>
							...
							<tbody>
								<?php $__empty_1 = true; $__currentLoopData = $tokens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $token): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
									<tr>
										...
										<td>
											<span class="text-sm"><?php echo e($token->created_at->format('M d, Y H:i')); ?></span>
										</td>
										<td>
											<?php if($token->last_used_at): ?>
												<span class="text-sm"><?php echo e($token->last_used_at->format('M d, Y H:i')); ?></span>
											<?php else: ?>
												<span class="text-secondary-light">Never used</span>
											<?php endif; ?>
										</td>
										<td>
											<?php if($token->has_usage): ?>
			...
			<div class="card border-0">
				<div class="card-body p-24">
					...
					<div class="d-flex flex-column gap-2">
						<a href="<?php echo e(route('admin.api-tokens.index')); ?>" class="btn btn-primary radius-12 justify-content-start">
							<iconify-icon icon="solar:wrench-outline" class="me-2"></iconify-icon>
							Manage Tokens
						</a>
						<a href="<?php echo e(route('admin.api.webhooks.index')); ?>" class="btn btn-warning radius-12 justify-content-start">
							<iconify-icon icon="solar:settings-outline" class="me-2"></iconify-icon>
							Webhook Configuration
						</a>
						<a href="<?php echo e(route('admin.api.webhook-logs.index')); ?>" class="btn btn-primary radius-12 justify-content-start">
							<iconify-icon icon="solar:document-text-outline" class="me-2"></iconify-icon>
							View Webhook Logs
						</a>
						<a href="<?php echo e(route('admin.api.test-console')); ?>" class="btn btn-success radius-12 justify-content-start">
							<iconify-icon icon="solar:code-square-outline" class="me-2"></iconify-icon>
							Test API
						</a>
						<a href="<?php echo e(route('admin.api.documentation')); ?>" class="btn btn-dark radius-12 justify-content-start">
			...
			<div class="card border-0 mt-3">
				<div class="card-body p-24">
					...
					<div class="mb-8">
						...
						<code class="text-danger text-sm d-block mt-1"><?php echo e(url('/api')); ?></code>
					</div>
					<div class="mb-8">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ecom123\resources\views/admin/api/usage-statistics.blade.php ENDPATH**/ ?>