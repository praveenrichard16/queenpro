...
<?php $__env->startSection('title', 'API Testing Console'); ?>
		...
		<div class="card-body p-24">
			<form id="api-test-form">
				...
				<div class="mb-24">
					...
					<input type="text" id="base-url" class="form-control bg-neutral-50 radius-12 h-56-px" value="<?php echo e(url('/api/v1')); ?>" readonly>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ecom123\resources\views/admin/api/test-console.blade.php ENDPATH**/ ?>