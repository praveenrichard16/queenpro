...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-hero','data' => ['breadcrumbs' => $breadcrumbs,'eyebrow' => $product->category?->name ?? 'Product detail','title' => $product->name,'description' => 'Crafted with premium materials and delivered with the care you expect from WowDash.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($breadcrumbs),'eyebrow' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->category?->name ?? 'Product detail'),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($product->name),'description' => 'Crafted with premium materials and delivered with the care you expect from WowDash.']); ?>
                            ...
                            <div class="gallery-thumbnails flex-shrink-0 w-20 md:w-24">
                                <div class="gallery-thumbnails-scroll overflow-y-auto max-h-[600px] pr-2" style="scrollbar-width: thin;">
                                    <?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="gallery-thumbnail cursor-pointer border-2 rounded-lg overflow-hidden transition-all mb-3 <?php echo e($index === 0 ? 'border-black' : 'border-transparent hover:border-gray-300'); ?>" 
                                             data-image-index="<?php echo e($index); ?>"
                                             onclick="changeMainImage(<?php echo e($index); ?>)">
                                            <img src="<?php echo e($image); ?>" alt="<?php echo e($product->name); ?> - Thumbnail <?php echo e($index + 1); ?>" 
                        ...
                        <div class="main-image-container flex-1">
                            <div class="main-image-wrapper relative bg-white rounded-2xl p-2 border border-gray-200 shadow-md">
                                <div class="popup-link cursor-pointer rounded-xl overflow-hidden">
                                    <img id="mainProductImage" src="<?php echo e($galleryImages->first()); ?>" 
                        ...
                        <div class="swiper-wrapper">
                            <?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide flex items-center justify-center">
                                    <img src="<?php echo e($image); ?>" alt="<?php echo e($product->name); ?>" class="max-w-full max-h-screen object-contain">
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                    <div class="sticky top-20 bg-white rounded-2xl p-6 md:p-8 border border-gray-200 shadow-sm">
                        ...
                        <div class="flex items-center gap-1 mt-3">
                            <div class="rate flex">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <i class="ph-fill ph-star text-sm <?php echo e($i <= round($product->average_rating) ? 'text-yellow' : 'text-secondary'); ?>"></i>
                                <?php endfor; ?>
                            </div>
                            <span class="caption1 text-secondary">(<?php echo e(number_format($product->total_reviews, 0)); ?> <?php echo e(Str::plural('review', $product->total_reviews)); ?>)</span>
                        </div>
                        <div class="flex items-center gap-3 flex-wrap mt-5 pb-6 border-b-2 border-gray-200">
                            <div class="product-price heading5 text-black font-bold"><?php echo e($product->formatted_effective_price); ?></div>
                            <?php if($product->has_discount): ?>
                                <div class="w-px h-4 bg-gray-300"></div>
                                <div class="product-origin-price font-normal text-gray-500">
                                    <del><?php echo e($product->formatted_price); ?></del>
                                </div>
                                <div class="product-sale caption2 font-semibold bg-green text-white px-3 py-1 inline-block rounded-full shadow-sm">-<?php echo e($discountPercent); ?>%</div>
                            <?php endif; ?>
                        </div>
                        <?php if($product->short_description): ?>
                            <div class="product-description text-secondary mt-4 p-4 bg-gray-50 rounded-lg border border-gray-100"><?php echo e($product->short_description); ?></div>
                        <?php endif; ?>
                        ...
                        <?php if(config('app.debug') && $product->enable_countdown_timer): ?>
                            <div class="mt-4 p-3 bg-yellow-100 border border-yellow-400 rounded text-sm">
                                <strong>Timer Debug:</strong><br>
                                Enable Timer: <?php echo e($product->enable_countdown_timer ? 'Yes' : 'No'); ?><br>
                                Timer End: <?php echo e($product->countdown_timer_end ? $product->countdown_timer_end : 'Not Set'); ?><br>
                                <?php if($timerEnd): ?>
                                    Parsed End: <?php echo e($timerEnd->format('Y-m-d H:i:s')); ?><br>
                                    Is Future: <?php echo e($showTimer ? 'Yes' : 'No'); ?><br>
                                    Current Time: <?php echo e(now()->format('Y-m-d H:i:s')); ?>

                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                        
                        <?php if($showTimer && $timerEnd): ?>
                            <div class="countdown-block flex items-center justify-between flex-wrap gap-y-4 mt-6 p-4 bg-red-50 rounded-lg border-2 border-red">
                                ...
                                <div class="countdown-time flex items-center lg:gap-5 gap-3 max-[400px]:justify-between max-[400px]:w-full" data-end-time="<?php echo e($timerEnd->timestamp); ?>">
                        ...
                        <div class="list-action mt-6">
                            <?php if($colorAttribute && $colorAttribute->values->isNotEmpty()): ?>
                                <div class="choose-color mt-5">
                                    ...
                                    <div class="list-color flex items-center gap-2 flex-wrap mt-3">
                                        <?php $__currentLoopData = $colorAttribute->values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colorValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="color-item w-12 h-12 rounded-xl duration-300 relative cursor-pointer border-2 border-transparent hover:border-black" 
                                                 data-color="<?php echo e($colorValue->value); ?>"
                                                 style="background-color: <?php echo e($colorValue->color_code ?? '#ccc'); ?>;"
                                                 title="<?php echo e($colorValue->value); ?>">
                                                <?php if($colorValue->image_path): ?>
                                                    <img src="<?php echo e(asset($colorValue->image_path)); ?>" alt="<?php echo e($colorValue->value); ?>" class="rounded-xl w-full h-full object-cover">
                                                <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <?php if($sizeAttribute && $sizeAttribute->values->isNotEmpty()): ?>
                                <div class="choose-size mt-5">
                                    ...
                                    <div class="list-size flex items-center gap-2 flex-wrap mt-3">
                                        <?php $__currentLoopData = $sizeAttribute->values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sizeValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="size-item w-12 h-12 flex items-center justify-center text-button rounded-full bg-white border border-line cursor-pointer duration-300 hover:bg-black hover:text-white hover:border-black <?php echo e(strtolower($sizeValue->value) === 'freesize' ? 'px-3 py-2' : ''); ?>" 
                                                 data-size="<?php echo e($sizeValue->value); ?>">
                                                <?php echo e($sizeValue->value); ?>
                            ...
                            <div class="choose-quantity flex items-center max-xl:flex-wrap lg:justify-between gap-5 mt-3">
                                ...
                                <form action="<?php echo e(route('cart.add')); ?>" method="POST" class="flex-1">
                                    ...
                                    <button type="submit" class="add-cart-btn button-main whitespace-nowrap w-full text-center bg-white text-black border border-black" <?php echo e($product->stock_quantity <= 0 ? 'disabled' : ''); ?>>
                                        Add To Cart
                                    </button>
                                </form>
                            </div>
                            <div class="button-block mt-5 grid grid-cols-1 md:grid-cols-2 gap-3">
                                <a href="<?php echo e(route('checkout')); ?>" class="button-main w-full text-center">Buy It Now</a>
                            ...
                            <div class="more-infor mt-6 p-5 bg-gray-50 rounded-xl border border-gray-200">
                                ...
                                <div class="flex items-center gap-1 mt-3">
                                    ...
                                    <div class="text-secondary"><?php echo e(now()->addDays(3)->format('d F')); ?> - <?php echo e(now()->addDays(7)->format('d F')); ?></div>
                                </div>
                                <div class="flex items-center gap-1 mt-3">
                                    <i class="ph ph-eye body1"></i>
                                    <div class="text-title"><?php echo e(rand(10, 50)); ?></div>
                                    <div class="text-secondary">people viewing this product right now!</div>
                                </div>
                                <div class="flex items-center gap-1 mt-3">
                                    <div class="text-title">SKU:</div>
                                    <div class="text-secondary"><?php echo e($product->id); ?><?php echo e(str_pad($product->category_id ?? 0, 3, '0', STR_PAD_LEFT)); ?></div>
                                </div>
                                <div class="flex items-center gap-1 mt-3">
                                    <div class="text-title">Categories:</div>
                                    <div class="list-category text-secondary">
                                        <?php if($product->category): ?>
                                            <a href="<?php echo e(route('products.category', $product->category->slug)); ?>" class="text-secondary hover:underline"><?php echo e($product->category->name); ?></a>
                                        <?php else: ?>
                                            Uncategorized
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-1 mt-3">
                                        ...
                                        <div class="list-tag text-secondary">
                                            <?php $__currentLoopData = $product->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(route('products.tag', $tag->slug)); ?>" class="text-secondary hover:underline"><?php echo e($tag->name); ?></a><?php if(!$loop->last): ?>, <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="main-content lg:pt-8 pt-6 lg:pb-6 pb-4 sm:px-4 px-3 border-2 border-gray-200 rounded-xl relative max-md:w-2/3 max-sm:w-full bg-gray-50 shadow-sm">
                                    ...
                                    <div class="list grid grid-cols-5 gap-3">
                                        ...
                                        <div class="item flex items-center justify-center lg:px-3 px-2 py-3 rounded-lg bg-white border border-gray-200 hover:border-gray-400 hover:shadow-md transition-all payment-logo-item">
                                            <img src="<?php echo e(asset('anvogue/images/payment/apple-pay.png')); ?>" alt="Apple Pay" class="h-8 w-auto max-w-full object-contain payment-logo-img" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                        ...
                                        <!-- Tabby -->
                                        <div class="item flex items-center justify-center lg:px-3 px-2 py-3 rounded-lg bg-white border border-gray-200 hover:border-gray-400 hover:shadow-md transition-all payment-logo-item">
                                            <img src="<?php echo e(asset('anvogue/images/payment/tabby.png')); ?>" alt="Tabby" class="h-8 w-auto max-w-full object-contain payment-logo-img" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            <div class="payment-logo-fallback hidden items-center justify-center">
                                        ...
                                        <!-- PayPal -->
                                        <div class="item flex items-center justify-center lg:px-3 px-2 py-3 rounded-lg bg-white border border-gray-200 hover:border-gray-400 hover:shadow-md transition-all payment-logo-item">
                                            <img src="<?php echo e(asset('anvogue/images/payment/paypal.png')); ?>" alt="PayPal" class="h-8 w-auto max-w-full object-contain payment-logo-img" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            <div class="payment-logo-fallback hidden items-center justify-center">
                                        ...
                                        <!-- Credit Card -->
                                        <div class="item flex items-center justify-center lg:px-3 px-2 py-3 rounded-lg bg-white border border-gray-200 hover:border-gray-400 hover:shadow-md transition-all payment-logo-item">
                                            <img src="<?php echo e(asset('anvogue/images/payment/credit-card.png')); ?>" alt="Credit Card" class="h-8 w-auto max-w-full object-contain payment-logo-img" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            <div class="payment-logo-fallback hidden items-center justify-center">
                                        ...
                                        <!-- Debit Card -->
                                        <div class="item flex items-center justify-center lg:px-3 px-2 py-3 rounded-lg bg-white border border-gray-200 hover:border-gray-400 hover:shadow-md transition-all payment-logo-item">
                                            <img src="<?php echo e(asset('anvogue/images/payment/debit-card.png')); ?>" alt="Debit Card" class="h-8 w-auto max-w-full object-contain payment-logo-img" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            <div class="payment-logo-fallback hidden items-center justify-center">
                                                <svg class="w-12 h-7" viewBox="0 0 48 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="desc-block mt-8">
                            ...
                            <div class="grid md:grid-cols-2 gap-8 gap-y-5">
                                <div class="left">
                                    ...
                                    <div class="text-secondary mt-2">
                                        ...
                                        <?php else: ?>
                                            <?php echo e($product->short_description ?? 'No description available.'); ?>
                    ...
                    <div class="desc-item specifications hidden" data-item="specifications">
                        <div class="specification-card premium-card">
                            ...
                            <?php elseif($product->attributes->isNotEmpty()): ?>
                                <div class="specification-table">
                                    <?php $__currentLoopData = $product->attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="specification-row <?php echo e($index % 2 === 0 ? 'bg-surface' : ''); ?>">
                                            <div class="specification-label"><?php echo e($attribute->name); ?></div>
                                            <div class="specification-value">
                                                <?php if($attribute->pivot->custom_value): ?>
                                                    <?php echo e($attribute->pivot->custom_value); ?>

                                                <?php elseif($attribute->pivot->attribute_value_id): ?>
                                                    <?php echo e($attribute->values->firstWhere('id', $attribute->pivot->attribute_value_id)?->value ?? 'N/A'); ?>
                            ...
                            <?php else: ?>
                                <div class="specification-table">
                                    <div class="specification-row">
                                        ...
                                        <div class="specification-value">
                                            <div class="flex items-center gap-1">
                                                <div class="rate flex">
                                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                                        <i class="ph-fill ph-star text-xs <?php echo e($i <= round($product->average_rating) ? 'text-yellow' : 'text-secondary'); ?>"></i>
                                                    <?php endfor; ?>
                                                </div>
                                    ...
                                    <div class="specification-row bg-surface">
                                        ...
                                        <div class="specification-value"><?php echo e($product->stock_quantity); ?> available</div>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="desc-item review hidden" data-item="review">
                        <div class="review-card premium-card">
                            ...
                            <div class="left flex max-sm:flex-col gap-y-4 items-center justify-between lg:w-1/2 sm:w-2/3 w-full sm:pr-5">
                                <div class="rating flex flex-col items-center">
                                    <div class="text-display"><?php echo e(number_format($product->average_rating, 1)); ?></div>
                                    <div class="flex flex-col items-center">
                                        <div class="rate flex">
                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                <i class="ph-fill ph-star text-lg <?php echo e($i <= round($product->average_rating) ? 'text-black' : 'text-secondary'); ?>"></i>
                                            <?php endfor; ?>
                                        </div>
                                        <div class="text-secondary text-center mt-1">(<?php echo e(number_format($product->total_reviews, 0)); ?> <?php echo e(Str::plural('Rating', $product->total_reviews)); ?>)</div>
                                    </div>
                                </div>
                                <div class="list-rating w-2/3">
                                    <?php for($i = 5; $i >= 1; $i--): ?>
                                        <div class="item flex items-center justify-between gap-1.5 <?php echo e($i < 5 ? 'mt-1' : ''); ?>">
                                            <div class="flex items-center gap-1">
                                                <div class="caption1"><?php echo e($i); ?></div>
                                                <i class="ph-fill ph-star text-sm"></i>
                                            </div>
                                            <div class="progress bg-line relative w-3/4 h-2">
                                                <div class="progress-percent absolute bg-yellow h-full left-0 top-0" style="width: <?php echo e($ratingBreakdown[$i]['percentage']); ?>%"></div>
                                            </div>
                                            <div class="caption1"><?php echo e($ratingBreakdown[$i]['percentage']); ?>%</div>
                                        </div>
                                    <?php endfor; ?>
                                </div>
                            </div>
                        ...
                        <div class="list-review mt-8">
                            <div class="heading flex items-center justify-between flex-wrap gap-4">
                                <div class="heading4"><?php echo e($reviews->count()); ?> <?php echo e(Str::plural('Comment', $reviews->count())); ?></div>
                            </div>
                            <?php if($reviews->count() > 0): ?>
                                <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item <?php echo e(!$loop->last ? 'mt-6 pb-6 border-b border-line' : 'mt-6'); ?>">
                                        <div class="heading flex items-center justify-between">
                                            <div class="user-infor flex gap-4">
                                                ...
                                                <div class="user">
                                                    <div class="flex items-center gap-2">
                                                        <div class="text-title"><?php echo e($review->customer_name); ?></div>
                                                        <div class="span text-line">-</div>
                                                        <div class="rate flex">
                                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                                <i class="ph-fill ph-star text-xs <?php echo e($i <= $review->rating ? 'text-yellow' : 'text-secondary'); ?>"></i>
                                                            <?php endfor; ?>
                                                        </div>
                                                    </div>
                                                    <div class="flex items-center gap-2">
                                        ...
                                        <?php if($review->title): ?>
                                            <div class="mt-3 font-semibold"><?php echo e($review->title); ?></div>
                                        <?php endif; ?>
                                        <?php if($review->comment): ?>
                                            <div class="mt-3"><?php echo e($review->comment); ?></div>
                                        <?php endif; ?>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                        ...
                        <div id="form-review" class="form-review pt-8">
                            ...
                            <form action="<?php echo e(route('products.reviews.store', $product)); ?>" method="POST" class="grid sm:grid-cols-2 gap-4 gap-y-5 mt-6">
                                <?php echo csrf_field(); ?>
                                <div class="name">
                                    <input class="border-line px-4 pt-3 pb-3 w-full rounded-lg <?php $__errorArgs = ['customer_name'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="text-red text-sm mt-1"><?php echo e($message); ?></div> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                </div>
                                <div class="mail">
                                    <input class="border-line px-4 pt-3 pb-3 w-full rounded-lg <?php $__errorArgs = ['customer_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red <?php unset($message);
                                    ...
                                    <div class="flex gap-2">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <label class="flex items-center gap-1 cursor-pointer">
                                                <input type="radio" name="rating" value="<?php echo e($i); ?>" <?php echo e(old('rating', 5) == $i ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-span-full message">
                                    <input class="border border-line px-4 py-3 w-full rounded-lg <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-span-full message">
                                    <textarea class="border border-line px-4 py-3 w-full rounded-lg <?php $__errorArgs = ['comment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                              id="message" name="comment" rows="3" placeholder="Your message *" required><?php echo e(old('comment')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="product-item">
                            <div class="bg-white rounded-2xl overflow-hidden h-full flex flex-col">
                                <a href="<?php echo e(route('products.show', $relatedProduct->id)); ?>" class="aspect-[3/4] overflow-hidden block">
                                    <img src="<?php echo e($relatedProduct->image ? asset($relatedProduct->image) : asset('shopus/assets/images/homepage-one/product-img/product-img-7.webp')); ?>" 
                                         alt="<?php echo e($relatedProduct->name); ?>" class="w-full h-full object-cover">
                                </a>
                                <div class="p-4 flex flex-col gap-2">
                                    <a href="<?php echo e(route('products.show', $relatedProduct->id)); ?>" class="text-title font-semibold text-black duration-300 hover:text-green"><?php echo e($relatedProduct->name); ?></a>
                                    <div>
                                        <span class="text-title font-semibold"><?php echo e($relatedProduct->formatted_effective_price); ?></span>
                                    ...
                                    <form action="<?php echo e(route('cart.add')); ?>" method="POST" class="mt-auto">
                                        ...
                                        <button type="submit" class="button-main w-full flex items-center justify-center gap-2 whitespace-nowrap" <?php echo e($relatedProduct->stock_quantity <= 0 ? 'disabled' : ''); ?>>
    ...
    <script>
        ...
        const galleryImages = <?php echo json_encode($galleryImages->values()->all(), 15, 512) ?>;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const maxQty = <?php echo e($product->stock_quantity); ?>;
