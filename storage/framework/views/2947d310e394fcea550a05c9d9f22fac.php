...
<?php $__env->startSection('title', 'WhatsApp Order Notifications Setup'); ?>
			...
			<div class="card border-0 mb-24">
				<div class="card-body p-24">
					...
					<div class="mb-24">
						...
						<ol class="mb-0">
							<li>Navigate to <a href="<?php echo e(route('admin.integrations.index', ['tab' => 'whatsapp'])); ?>">Admin Panel → Integrations → WhatsApp</a></li>
					...
					<div class="mb-24">
						...
						<div class="border radius-12 p-3 mb-3">
							...
							<ol class="mb-2">
								...
								<li>Add body text with variables:
									<pre class="bg-neutral-50 p-2 radius-8 mt-2"><code>Hello <?php echo e(1); ?>, your order <?php echo e(2); ?> has been confirmed. Total amount: <?php echo e(3); ?>. Thank you for your purchase!</code></pre>
								</li>
								<li>Variables:
									<ul>
										<li><code><?php echo e(1); ?></code> = Customer Name</li>
										<li><code><?php echo e(2); ?></code> = Order Number</li>
										<li><code><?php echo e(3); ?></code> = Order Total</li>
									</ul>
								</li>
						...
						<div class="border radius-12 p-3">
							...
							<ol class="mb-2">
								...
								<li>Category: UTILITY</li>
								<li>Body text:
									<pre class="bg-neutral-50 p-2 radius-8 mt-2"><code>Hello <?php echo e(1); ?>, your order <?php echo e(2); ?> status has been updated from <?php echo e(3); ?> to <?php echo e(4); ?>. Track your order on our website.</code></pre>
								</li>
								<li>Variables:
									<ul>
										<li><code><?php echo e(1); ?></code> = Customer Name</li>
										<li><code><?php echo e(2); ?></code> = Order Number</li>
										<li><code><?php echo e(3); ?></code> = Old Status</li>
										<li><code><?php echo e(4); ?></code> = New Status</li>
									</ul>
								</li>
					...
					<div class="mb-24">
						...
						<ol class="mb-0">
							<li>In <a href="<?php echo e(route('admin.integrations.index', ['tab' => 'whatsapp'])); ?>">Admin Panel → Integrations → WhatsApp</a></li>
			...
			<div class="card border-0 mb-24">
				<div class="card-body p-24">
					...
					<div class="d-flex flex-column gap-2">
						<a href="<?php echo e(route('admin.integrations.index', ['tab' => 'whatsapp'])); ?>" class="btn btn-outline-primary">
				...
				<div class="card-body p-24">
					...
					<div>
						...
						<ul class="text-sm">
							<li><code><?php echo e(1); ?></code> - Customer Name</li>
							<li><code><?php echo e(2); ?></code> - Order Number</li>
							<li><code><?php echo e(3); ?></code> - Previous Status</li>
							<li><code><?php echo e(4); ?></code> - New Status</li>
						</ul>
					</div>
				</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ecom123\resources\views/admin/integrations/whatsapp-order-notifications-docs.blade.php ENDPATH**/ ?>