...
<?php $__env->startSection('title', 'Lead Source'); ?>
	...
	<div class="row">
			...
			<div class="card border-0 h-100">
				<div class="card-body p-16">
					<div class="nav flex-column nav-pills gap-2" id="lead-source-tabs" role="tablist" aria-orientation="vertical">
						<button class="btn btn-outline-secondary d-flex justify-content-between align-items-center <?php echo e((request('tab') === 'add' || !request('tab')) ? 'active' : ''); ?>" id="lead-source-tab-add" data-bs-toggle="pill" data-bs-target="#lead-source-pane-add" type="button" role="tab" aria-controls="lead-source-pane-add" aria-selected="<?php echo e((request('tab') === 'add' || !request('tab')) ? 'true' : 'false'); ?>">
							<span>Add Lead Source</span>
							<iconify-icon icon="solar:add-circle-linear" class="text-lg"></iconify-icon>
						</button>
						<button class="btn btn-outline-secondary d-flex justify-content-between align-items-center <?php echo e(request('tab') === 'manage' ? 'active' : ''); ?>" id="lead-source-tab-manage" data-bs-toggle="pill" data-bs-target="#lead-source-pane-manage" type="button" role="tab" aria-controls="lead-source-pane-manage" aria-selected="<?php echo e(request('tab') === 'manage' ? 'true' : 'false'); ?>">
		...
		<div class="col-lg-9">
			<div class="tab-content" id="lead-source-tabs-content">
				<!-- Add Lead Source Tab -->
				<div class="tab-pane fade <?php echo e((request('tab') === 'add' || !request('tab')) ? 'show active' : ''); ?>" id="lead-source-pane-add" role="tabpanel" aria-labelledby="lead-source-tab-add">
					<div class="card border-0">
						<div class="card-body p-24">
							<form method="POST" action="<?php echo e(route('admin.lead-sources.store')); ?>" class="row g-4">
								<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
								...
								<div class="col-12">
									<div class="form-check form-switch">
										<input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" <?php if(old('is_active', true)): echo 'checked'; endif; ?>>
				...
				<div class="tab-pane fade <?php echo e(request('tab') === 'manage' ? 'show active' : ''); ?>" id="lead-source-pane-manage" role="tabpanel" aria-labelledby="lead-source-tab-manage">
					<div class="card border-0">
											...
											<tr>
												...
												<td class="text-end">
													<div class="d-inline-flex gap-2">
														<a href="<?php echo e(route('admin.lead-sources.edit', $leadSource)); ?>?tab=manage" class="w-36-px h-36-px bg-primary-focus text-primary-main rounded-circle d-inline-flex align-items-center justify-content-center">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ecom123\resources\views/admin/lead-sources/index-tabbed.blade.php ENDPATH**/ ?>